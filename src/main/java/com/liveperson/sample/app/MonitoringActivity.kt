    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        getEngagementButton.setOnClickListener {
            ...
            try {
                ...
                Log.d(TAG, "before showConversation$consumerIdFromUI");
...
//                val lpAuthenticationParams =  LPAuthenticationParams(LPAuthenticationType.UN_AUTH);
//                LivePerson.showConversation(MonitoringActivity@this, lpAuthenticationParams,  ConversationViewParams());

//                LPAuthenticationParams lpAuthenticationParams = new LPAuthenticationParams(LPAuthenticationType.UN_AUTH);
//                LivePerson.showConversation(MonitoringActivity.this, lpAuthenticationParams,  new ConversationViewParams(false));
